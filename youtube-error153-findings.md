...
- رابط التضمين المباشر `https://www.youtube.com/embed/bZ_uV-dYkx0?...&origin=https://dr.africacold.fr` أظهر `Error 153 — Video player configuration error` قبل فتحه من منصة الأكاديمية.
...
- الإصلاح المرجح: تغيير سياسة HTTP إلى `strict-origin-when-cross-origin`، وإضافة `referrerpolicy="strict-origin-when-cross-origin"` إلى iframe، مع إبقاء `origin=https://dr.africacold.fr` في URL.
