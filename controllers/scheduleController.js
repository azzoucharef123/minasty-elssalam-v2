...
function serializeRegistryClass(item, { teacher = false, student = null } = {}) {
  ...
  return {
    ...
    youtubeEmbedUrl: canRevealVideo && youtubeVideoId ? `https://www.youtube.com/embed/${youtubeVideoId}?controls=0&disablekb=1&fs=1&iv_load_policy=3&rel=0&playsinline=1&enablejsapi=1&origin=https://dr.africacold.fr` : null,
