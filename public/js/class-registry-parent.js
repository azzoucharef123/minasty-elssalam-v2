...
(() => {
  ...
  function formatDate(value) {
    ...
    return Number.isFinite(date.getTime()) ? new Intl.DateTimeFormat("ar-DZ", { weekday: "long", day: "numeric", month: "long", year: "numeric", hour: "2-digit", minute: "2-digit" }).format(date) : "تاريخ غير صالح";
  }
